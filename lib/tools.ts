...
export interface Tool {
  ...
  vercelUrl: string  // placeholder — update once deployed
...
export const TOOLS: Tool[] = [
  {
    ...
    vercelUrl: 'https://calendar-scheduler-kato8.vercel.app',
    access: {
  ...
  },
  {
    ...
    vercelUrl: 'https://hr-tool-kato8.vercel.app',
    access: {
      super_admin:          'super_admin',
      team_lead:            'full',
      social_media_manager: 'full',
  ...
  },
  {
    ...
    vercelUrl: 'https://social-media-dash-kato8.vercel.app',
    access: {
      super_admin:          'super_admin',
      team_lead:            'view',
  ...
  },
  {
    ...
    vercelUrl: 'https://video-editor-kato8.vercel.app',
    access: {
      super_admin:          'super_admin',
      team_lead:            'none',
      social_media_manager: 'full',
  ...
  },
  {
    ...
    vercelUrl: 'https://executive-assistant-kato8.vercel.app',
    access: {
      super_admin:          'super_admin',
      team_lead:            'none',
  ...
  },
  {
    ...
    vercelUrl: 'https://legal-agent-kato8.vercel.app',
    access: {
      super_admin:          'super_admin',
      team_lead:            'none',
      social_media_manager: 'none',
